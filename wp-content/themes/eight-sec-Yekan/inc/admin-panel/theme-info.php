...
class Eight_sec_About_Theme {
	...
	public function __construct() {
		...
		$this->eight_sec_req_plugins = array(
			...
			'instant-demo-importer' => array(
				...
				'name' => __('Instant Demo Importer', 'eight-sec'),
				...
				'info' => __('Instant Demo Importer Plugin adds the feature to Import the Demo Conent with a single click.', 'eight-sec'),
				),
			);
	...
	public function eight_sec_welcome_register_menu() {
		$title = __( 'About Eight Sec', 'eight-sec' );

		add_theme_page( __( 'About Eight Sec', 'eight-sec' ), $title, 'edit_theme_options', 'eight-sec-about', array(
			$this,
	...
	public function eight_sec_about_theme_page() {
		...
		<div class="wrap eight-sec-wrap">
			...
			<div class="top-wrap">
				<div class="text-wrap">
					<h1><?php echo __( 'Welcome to Eight Sec! - Version ', 'eight-sec' ) . esc_html( $eight_sec['Version'] ); ?></h1>
				...
				<div class="logo-wrap">
					<a target="_blank" href="<?php echo esc_url('https://8degreethemes.com/wordpress-themes/eight-sec-pro/');?>"><img src="<?php echo esc_url('http://8degreethemes.com/demo/upgrade-eight-sec.jpg');?>" alt="<?php echo __('UPGRADE TO Eight Sec PRO','eight-sec');?>"></a>
				</div>
			</div>
			...
			<div class="bottom-block">
				<ul class="eight-sec-tab-wrapper wp-clearfix">
					...
					<li><a target="_blank" href="<?php echo esc_url('https://wpall.club/'); ?>"
						class="eight-sec-tab more-wp"><?php echo esc_html__( 'WordPress Resources', 'eight-sec' ); ?>
	...
	public function eight_sec_welcome_admin_notice() {
		...
		<div class="updated notice is-dismissible">
			<p><?php echo sprintf( esc_html__( 'Welcome! Thank you for choosing Eight Sec! To fully take advantage of the best our theme can offer please make sure you visit our %swelcome page%s.', 'eight-sec' ), '<a href="' . esc_url( admin_url( 'themes.php?page=eight-sec-about' ) ) . '">', '</a>' ); ?></p>
			<p><a href="<?php echo esc_url( admin_url( 'themes.php?page=eight-sec-about' ) ); ?>" class="button"
				style="text-decoration: none;"><?php _e( 'Get started with Eight Sec', 'eight-sec' ); ?></a></p>
			</div>
			<?php
		}
		...
		public function get_local_dir_path($plugin) {
			...
			$url = wp_nonce_url(admin_url('themes.php??page=eight-sec-about&tab=demo_import'),'bloog-file-installation');
			...
			public function eight_sec_plugin_installer_callback(){
				...
				if ( ! current_user_can('install_plugins') )
					wp_die( __( 'Sorry, you are not allowed to install plugins on this site.', 'eight-sec' ) );
				...
				if (! wp_verify_nonce( $nonce, 'eight_sec_plugin_installer_nonce' ))
					wp_die( __( 'Error - unable to verify nonce, please try again.', 'eight-sec') );
			...
			public function eight_sec_plugin_activation_callback(){
				...
				if ( ! current_user_can('install_plugins') )
					wp_die( __( 'Sorry, you are not allowed to activate plugins on this site.', 'eight-sec' ) );
				...
				if (! wp_verify_nonce( $nonce, 'eight_sec_plugin_activate_nonce' ))
					die( __( 'Error - unable to verify nonce, please try again.', 'eight-sec' ) );
	...
	/** Initializing Demo Importer if exists **/
		...
		$demoimporter->demos = array(
			'eight-sec' => array(
				'title' => __('Eight Sec Demo', 'eight-sec'),
				'name' => 'eight-sec',
