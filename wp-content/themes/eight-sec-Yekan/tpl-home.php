			...
			<section id="<?php echo eight_sec_hyphenize($portfolio_menu);?>" class="eight_sec_plx_portfolio_section section">
				<div class="ed-container">
					...
					if( !empty($portfolio_page)  && ($portfolio_page != 0) ):?>
						...
						<?php echo apply_filters( 'the_content', get_post_field('post_content', $portfolio_data->ID) );?></p>
					<?php 					
					endif;
			...
			<section id="<?php echo eight_sec_hyphenize($team_menu);?>" class="eight_sec_plx_team_section section">
				<div class="ed-container">
					...
					if( !empty($team_page) && ($team_page != 0) ):?>
						...
						<?php endif;?>
						<p class="team-description wow fadeInDown" data-wow-duration="2s" >
						<?php echo apply_filters( 'the_content', get_post_field('post_content', $team_data->ID) );?></p>
					<?php
					endif;
		...
		<section id="<?php echo eight_sec_hyphenize($cta_menu);?>" class="eight_sec_plx_cta_section section">
			<div class="ed-container">
				...
				<p class="cta-description wow fadeInDown" data-wow-duration="2s" >
						<?php echo apply_filters( 'the_content', get_post_field('post_content', $cta_data->ID) );?></p>
			...
			<section id="<?php echo eight_sec_hyphenize($blog_menu);?>" class="eight_sec_plx_blog_section section">
				<div class="ed-container">
					...
					if(!empty($blog_page) && ($blog_page != 0)):?>
						...
						<?php endif;?>
						<p class="blog-description wow fadeInDown" data-wow-duration="2s" >
						<?php echo apply_filters( 'the_content', get_post_field('post_content', $blog_data->ID) );?></p>
					<?php		
					endif;			
			...
			<section id="<?php echo eight_sec_hyphenize($testimonial_menu);?>" class="eight_sec_plx_testimonial_section section">
				<div class="ed-container">
					...
					if(!empty($testimonial_page) && ($testimonial_page != 0) ):?>
						...
						<?php echo apply_filters( 'the_content', get_post_field('post_content', $testimonial_data->ID) );?></p>						
					<?php 					
					endif;
			...
			<div class="ed-container">
				...
				if(!empty($contact_page)):?>
					...
					<p class="contact-description wow fadeInDown" data-wow-duration="2s" >
						<?php echo apply_filters( 'the_content', get_post_field('post_content', $contact_data->ID) );?></p>					
				<?php 
				endif;
