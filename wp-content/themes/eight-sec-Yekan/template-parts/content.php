...
$readmore = get_theme_mod('eight_sec_blog_archive_setting_readmore',__('ادامه مطلب','eight-sec'));
switch ($blog_layout) {
	...
	<div class="entry-content">
		...
		<div class="archive-content">
			...
			<div class="ed-readmore">
          		<a href="<?php the_permalink(); ?>"><?php esc_html_e('ادامه مطلب','eight-sec');?></a>
        	</div>
		</div>
	...
	<article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
		...
		<div class="entry-content">
			...
			<?php the_content( sprintf(
				...
				wp_kses( __( 'Continue reading %s <span class="meta-nav">→</span>', 'eight-sec' ), array( 'span' => array( 'class' => array() ) ) ),
