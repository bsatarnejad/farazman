...
function hamyarwp_after_import_setup() {
	...
	$side_menu = get_term_by('name', 'منوی کناری', 'nav_menu');
    $footer_menu = get_term_by('name', 'منوی فوتر', 'nav_menu');
	$social_menu = get_term_by('name', 'شبکه های اجتماعی', 'nav_menu');
	set_theme_mod( 'nav_menu_locations', array(
			'primary' => $main_menu->term_id,
		    'side-nav-menu' => $side_menu->term_id,
	     	'footermenu' => $footer_men->term_id,
