		...
		<main id="main" class="site-main" role="main">
			...
			while( have_posts() ) {
				...
				<header class="entry-header">
					...
					<?php if($idyllic_entry_meta_single=='show'){ ?>
					<div class="entry-meta">
						<span class="author vcard"><?php esc_html_e('نوشته شده توسط','idyllic');?><a href="<?php echo get_author_posts_url( get_the_author_meta( 'ID' ) ); ?>" title="<?php the_author(); ?>">
						...
						<?php comments_popup_link( __( 'بدون دیدگاه', 'idyllic' ), __( 'یک دیدگاه', 'idyllic' ), __( '% دیدگاه ها', 'idyllic' ), '', __( 'دیدگاه بسته شده', 'idyllic' ) ); ?> </span>
						<?php } ?>
					</div><!-- end .entry-meta -->
					<?php } ?>
				</header>
				...
				the_post_navigation( array(
						'next_text' => '<span class="meta-nav" aria-hidden="true">' . __( 'بعدی', 'idyllic' ) . '</span> ' .
							'<span class="screen-reader-text">' . __( 'مطلب بعدی:', 'idyllic' ) . '</span> ' .
							'<span class="post-title">%title</span>',
						'prev_text' => '<span class="meta-nav" aria-hidden="true">' . __( 'قبلی', 'idyllic' ) . '</span> ' .
							'<span class="screen-reader-text">' . __( 'مطلب قبلی:', 'idyllic' ) . '</span> ' .
							'<span class="post-title">%title</span>',
					) );
				}
			} ?>
