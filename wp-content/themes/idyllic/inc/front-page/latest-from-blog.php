						...
						<article id="post-<?php the_ID(); ?>" <?php post_class();?>>
							...
							<div class="latest-blog-text">
								<header class="entry-header">
									...
									<div class="entry-meta">
										<span class="author vcard"><?php esc_html_e('نوشته شده توسط','idyllic');?><a href="<?php echo get_author_posts_url( get_the_author_meta( 'ID' ) ); ?>" title="author"><?php the_author(); ?></a></span>
										...
										<?php comments_popup_link( __( 'بدون دیدگاه', 'idyllic' ), __( 'یک دیدگاه', 'idyllic' ), __( '% دیدگاه ها', 'idyllic' ), '', __( 'دیدگاه بسته است', 'idyllic' ) ); ?> </span>
										<?php } ?>
									</div><!-- end .entry-meta -->
