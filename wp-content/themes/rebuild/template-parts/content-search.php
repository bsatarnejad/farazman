 ...
 */
 ...
 $data['checkbox_slideshow']=true;
 $data['text_slideshow_count']=2;
                                        ...
                                        <li>
                                            ...
                                            <div class="full-video">
                                                ...
                                                <?php 
													...
													echo $wp_embed->run_shortcode('[embed height="330"]'.esc_url(get_post_meta(get_the_ID(), 'rebuild_video_code', true)).'[/embed]');															
                                                    echo $post_embed;
                                                 ?>
