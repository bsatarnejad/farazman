...
class Vc_IconPicker {
	...
	protected function setDefaults() {
		...
		if ( ! isset( $this->settings['settings'], $this->settings['settings']['allCategoryText'] ) ) {
			...
			$this->settings['settings']['allCategoryText'] = esc_html__( 'From all categories', 'rebuild' );
		}
		if ( ! isset( $this->settings['settings'], $this->settings['settings']['unCategorizedText'] ) ) {
			// If categorized then use this option
			$this->settings['settings']['unCategorizedText'] = esc_html__( 'Uncategorized', 'rebuild' );
		}
		/**
...
add_filter( 'vc_iconpicker-type-streamline', 'vc_iconpicker_type_streamline' );
/**
 * Linecons icons from fontello.com
 *
 * @param $icons - taken from filter - vc_map param field settings['source'] provided icons (default empty array).
 ...
 * @return array - of icons for iconpicker, can be categorized, or not.
 */
function vc_iconpicker_type_streamline( $icons ) {
	$streamline_icons = array(
		array( 'stream-icon stream-icon-armchair-chair-streamline' => 'armchair' ),
		array( 'stream-icon stream-icon-arrow-streamline-target' => 'arrowstreamline' ),
		array( 'stream-icon stream-icon-backpack-streamline-trekking' => 'backpackstreamline' ),
		array( 'stream-icon stream-icon-bag-shopping-streamline' => 'bag-shoppingstreamline' ),
		array( 'stream-icon stream-icon-barista-coffee-espresso-streamline' => 'barista-coffee' ),
		array( 'stream-icon stream-icon-barbecue-eat-food-streamline' => 'barbecue' ),
		array( 'stream-icon stream-icon-bomb-bug' => 'bomb-bug' ),
		array( 'stream-icon stream-icon-book-dowload-streamline' => 'dowloadstreamline' ),
		array( 'stream-icon stream-icon-book-read-streamline' => 'readstreamline' ),
		array( 'stream-icon stream-icon-browser-streamline-window' => 'windowt' ),
		array( 'stream-icon stream-icon-brush-paint-streamline' => 'brush-paintstreamline' ),
		array( 'stream-icon stream-icon-bubble-comment-streamline-talk' => 'bubble-comment' ),
		array( 'stream-icon stream-icon-bubble-love-streamline-talk' => 'bubble-love' ),
		array( 'stream-icon stream-icon-computer-macintosh-vintage' => 'computer-macintosh' ),
		array( 'stream-icon stream-icon-computer-imac-2' => 'computer-imac-2' ),
		array( 'stream-icon stream-icon-computer-imac' => 'computer-imac' ),
		array( 'stream-icon stream-icon-coffee-streamline' => 'coffeestreamline' ),
		array( 'stream-icon stream-icon-cocktail-mojito-streamline' => 'cocktail-mojitostreamline' ),
		array( 'stream-icon stream-icon-clock-streamline-time' => 'clockstreamline' ),
		array( 'stream-icon stream-icon-chef-food-restaurant-streamline' => 'chef-food' ),
		array( 'stream-icon stream-icon-chaplin-hat-movie-streamline' => 'chaplin' ),
		array( 'stream-icon stream-icon-camera-streamline-video' => 'camerastreamline' ),
		array( 'stream-icon stream-icon-camera-photo-streamline' => 'photostreamline' ),
		array( 'stream-icon stream-icon-camera-photo-polaroid-streamline' => 'polaroidstreamline' ),
		array( 'stream-icon stream-icon-caddie-shop-shopping-streamline' => 'shoppingstreamline' ),
		array( 'stream-icon stream-icon-computer-network-streamline' => 'networkstreamline' ),
		array( 'stream-icon stream-icon-computer-streamline' => 'computerstreamline' ),
		array( 'stream-icon stream-icon-caddie-shopping-streamline' => 'caddie-shoppingstreamline' ),
		array( 'stream-icon stream-icon-cook-pan-pot-streamline' => 'ook-pan' ),
		array( 'stream-icon stream-icon-crop-streamline' => 'cropstreamline' ),
		array( 'stream-icon stream-icon-crown-king-streamline' => 'crown-kingstreamline' ),
		array( 'stream-icon stream-icon-danger-death-delete-destroy-skull-stream' => 'danger-death' ),
		array( 'stream-icon stream-icon-dashboard-speed-streamline' => 'dashboard-speedstreamline' ),
		array( 'stream-icon stream-icon-database-streamline' => 'databasestreamline' ),
		array( 'stream-icon stream-icon-delete-garbage-streamline' => 'delete-garbagestreamline' ),
		array( 'stream-icon stream-icon-design-graphic-tablet-streamline-tablet' => 'design-graphic-tabletstreamline' ),
		array( 'stream-icon stream-icon-design-pencil-rule-streamline' => 'design-pencil' ),
		array( 'stream-icon stream-icon-diving-leisure-sea-sport-streamline' => 'diving-leisure' ),
		array( 'stream-icon stream-icon-drug-medecine-streamline-syringue' => 'drug-medecinestreamline' ),
		array( 'stream-icon stream-icon-handle-streamline-vector' => 'handlestreamline' ),
		array( 'stream-icon stream-icon-grid-lines-streamline' => 'grid-linesstreamline' ),
		array( 'stream-icon stream-icon-frame-picture-streamline' => 'frame-picturestreamline' ),
		array( 'stream-icon stream-icon-food-ice-cream-streamline' => 'food-ice-cream' ),
		array( 'stream-icon stream-icon-first-aid-medecine-shield-streamline' => 'first-aid-medecine' ),
		array( 'stream-icon stream-icon-factory-lift-streamline-warehouse' => 'factory-lift' ),
		array( 'stream-icon stream-icon-eye-dropper-streamline' => 'eye-dropper' ),
		array( 'stream-icon stream-icon-envellope-mail-streamline' => 'envellope-mail' ),
		array( 'stream-icon stream-icon-email-mail-streamline' => 'email-mail' ),
		array( 'stream-icon stream-icon-edit-modify-streamline' => 'edit-modify' ),
		array( 'stream-icon stream-icon-eat-food-hotdog-streamline' => 'eat-food-hotdog' ),
		array( 'stream-icon stream-icon-eat-food-fork-knife-streamline' => 'food-fork-knif' ),
		array( 'stream-icon stream-icon-earth-globe-streamline' => 'earth-globe' ),
		array( 'stream-icon stream-icon-happy-smiley-streamline' => 'happy-smiley' ),
		array( 'stream-icon stream-icon-headset-sound-streamline' => 'headset-sound' ),
		array( 'stream-icon stream-icon-home-house-streamline' => 'home-house' ),
		array( 'stream-icon stream-icon-ibook-laptop' => 'ibook-laptop' ),
		array( 'stream-icon stream-icon-ink-pen-streamline' => 'ink-pen' ),
		array( 'stream-icon stream-icon-ipad-streamline' => 'ipad' ),
		array( 'stream-icon stream-icon-iphone-streamline' => 'iphone' ),
		array( 'stream-icon stream-icon-ipod-mini-music-streamline' => 'ipod-mini-music' ),
		array( 'stream-icon stream-icon-ipod-music-streamline' => 'ipod-music' ),
		array( 'stream-icon stream-icon-ipod-streamline' => 'ipod' ),
		array( 'stream-icon stream-icon-japan-streamline-tea' => 'japanstreamline-tea' ),
		array( 'stream-icon stream-icon-laptop-macbook-streamline' => 'laptop-macbook' ),
		array( 'stream-icon stream-icon-like-love-streamline' => 'like-love' ),
		array( 'stream-icon stream-icon-music-speaker-streamline' => 'music-speaker' ),
		array( 'stream-icon stream-icon-remote-control-streamline' => 'remote-control' ),
		array( 'stream-icon stream-icon-receipt-shopping-streamline' => 'receipt-shopping' ),
		array( 'stream-icon stream-icon-music-note-streamline' => 'music-note' ),
		array( 'stream-icon stream-icon-monocle-mustache-streamline' => 'monocle-mustache' ),
		array( 'stream-icon stream-icon-picture-streamline-1' => 'picture-1' ),
		array( 'stream-icon stream-icon-picture-streamline' => 'picture' ),
		array( 'stream-icon stream-icon-micro-record-streamline' => 'micro-record' ),
		array( 'stream-icon stream-icon-map-streamline-user' => 'maps' ),
		array( 'stream-icon stream-icon-photo-pictures-streamline' => 'photo-pictures' ),
		array( 'stream-icon stream-icon-pen-streamline-3' => 'pens' ),
		array( 'stream-icon stream-icon-map-pin-streamline' => 'map-pin' ),
		array( 'stream-icon stream-icon-man-people-streamline-user' => 'man-people' ),
		array( 'stream-icon stream-icon-pen-streamline-2' => 'pen-2' ),
		array( 'stream-icon stream-icon-pen-streamline-1' => 'pen-1' ),
		array( 'stream-icon stream-icon-magnet-streamline' => 'magnet' ),
		array( 'stream-icon stream-icon-magic-magic-wand-streamline' => 'magic-wands' ),
		array( 'stream-icon stream-icon-painting-roll-streamline' => 'painting-roll' ),
		array( 'stream-icon stream-icon-macintosh' => 'macintosh' ),
		array( 'stream-icon stream-icon-locker-streamline-unlock' => 'locker' ),
		array( 'stream-icon stream-icon-painting-pallet-streamline' => 'painting-pallet' ),
		array( 'stream-icon stream-icon-paint-bucket-streamline' => 'paint-bucket' ),
		array( 'stream-icon stream-icon-lock-locker-streamline' => 'lock-locker' ),
		array( 'stream-icon stream-icon-link-streamline' => 'link' ),
		array( 'stream-icon stream-icon-notebook-streamline' => 'notebook' ),
		array( 'stream-icon stream-icon-settings-streamline' => 'setting' ),
		array( 'stream-icon stream-icon-settings-streamline-1' => 'setting-1' ),
		array( 'stream-icon stream-icon-shoes-snickers-streamline' => 'shoes-snickers' ),
		array( 'stream-icon stream-icon-speech-streamline-talk-user' => 'speechs' ),
		array( 'stream-icon stream-icon-stamp-streamline' => 'stamp' ),
		array( 'stream-icon stream-icon-streamline-suitcase-travel' => 'suitcase-travel' ),
		array( 'stream-icon stream-icon-streamline-sync' => 'sync' ),
		array( 'stream-icon stream-icon-streamline-umbrella-weather' => 'umbrella-weather' ),
		array( 'stream-icon stream-icon-settings-streamline-2' => 'setting-2' ),
	);
	return array_merge( $icons, $streamline_icons );
}