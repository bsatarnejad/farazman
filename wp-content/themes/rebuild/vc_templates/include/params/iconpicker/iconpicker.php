...
function vc_iconpicker_type_streamline( $icons ) {
	$streamline_icons = array(
		array( 'stream-icon-armchair-chairstreamline' => 'armchair' ),
		array( 'stream-icon-arrowstreamline-target' => 'arrowstreamline' ),
		array( 'stream-icon-backpackstreamline-trekking' => 'backpackstreamline' ),
		array( 'stream-icon-bag-shoppingstreamline' => 'bag-shoppingstreamline' ),
		array( 'stream-icon-barista-coffee-espressostreamline' => 'barista-coffee' ),
		array( 'stream-icon-barbecue-eat-foodstreamline' => 'barbecue' ),
		array( 'stream-icon-bomb-bug' => 'bomb-bug' ),
		array( 'stream-icon-book-dowloadstreamline' => 'dowloadstreamline' ),
		array( 'stream-icon-book-readstreamline' => 'readstreamline' ),
		array( 'stream-icon-browserstreamline-window' => 'windowt' ),
		array( 'stream-icon-brush-paintstreamline' => 'brush-paintstreamline' ),
		array( 'stream-icon-bubble-commentstreamline-talk' => 'bubble-comment' ),
		array( 'stream-icon-bubble-lovestreamline-talk' => 'bubble-love' ),
		array( 'stream-icon-computer-macintosh-vintage' => 'computer-macintosh' ),
		array( 'stream-icon-computer-imac-2' => 'computer-imac-2' ),
		array( 'stream-icon-computer-imac' => 'computer-imac' ),
		array( 'stream-icon-coffeestreamline' => 'coffeestreamline' ),
		array( 'stream-icon-cocktail-mojitostreamline' => 'cocktail-mojitostreamline' ),
		array( 'stream-icon-clockstreamline-time' => 'clockstreamline' ),
		array( 'stream-icon-chef-food-restaurantstreamline' => 'chef-food' ),
		array( 'stream-icon-chaplin-hat-moviestreamline' => 'chaplin' ),
		array( 'stream-icon-camerastreamline-video' => 'camerastreamline' ),
		array( 'stream-icon-camera-photostreamline' => 'photostreamline' ),
		array( 'stream-icon-camera-photo-polaroidstreamline' => 'polaroidstreamline' ),
		array( 'stream-icon-caddie-shop-shoppingstreamline' => 'shoppingstreamline' ),
		array( 'stream-icon-computer-networkstreamline' => 'networkstreamline' ),
		array( 'stream-icon-computerstreamline' => 'computerstreamline' ),
		array( 'stream-icon-caddie-shoppingstreamline' => 'caddie-shoppingstreamline' ),
		array( 'stream-icon-cook-pan-potstreamline' => 'ook-pan' ),
		array( 'stream-icon-cropstreamline' => 'cropstreamline' ),
		array( 'stream-icon-crown-kingstreamline' => 'crown-kingstreamline' ),
		array( 'stream-icon-danger-death-delete-destroy-skullstream' => 'danger-death' ),
		array( 'stream-icon-dashboard-speedstreamline' => 'dashboard-speedstreamline' ),
		array( 'stream-icon-databasestreamline' => 'databasestreamline' ),
		array( 'stream-icon-delete-garbagestreamline' => 'delete-garbagestreamline' ),
		array( 'stream-icon-design-graphic-tabletstreamline-tablet' => 'design-graphic-tabletstreamline' ),
		array( 'stream-icon-design-pencil-rulestreamline' => 'design-pencil' ),
		array( 'stream-icon-diving-leisure-sea-sportstreamline' => 'diving-leisure' ),
		array( 'stream-icon-drug-medecinestreamline-syringue' => 'drug-medecinestreamline' ),
		array( 'stream-icon-handlestreamline-vector' => 'handlestreamline' ),
		array( 'stream-icon-grid-linesstreamline' => 'grid-linesstreamline' ),
		array( 'stream-icon-frame-picturestreamline' => 'frame-picturestreamline' ),
		array( 'stream-icon-food-ice-creamstreamline' => 'food-ice-cream' ),
		array( 'stream-icon-first-aid-medecine-shieldstreamline' => 'first-aid-medecine' ),
		array( 'stream-icon-factory-liftstreamline-warehouse' => 'factory-lift' ),
		array( 'stream-icon-eye-dropperstreamline' => 'eye-dropper' ),
		array( 'stream-icon-envellope-mailstreamline' => 'envellope-mail' ),
		array( 'stream-icon-email-mailstreamline' => 'email-mail' ),
		array( 'stream-icon-edit-modifystreamline' => 'edit-modify' ),
		array( 'stream-icon-eat-food-hotdogstreamline' => 'eat-food-hotdog' ),
		array( 'stream-icon-eat-food-fork-knifestreamline' => 'food-fork-knif' ),
		array( 'stream-icon-earth-globestreamline' => 'earth-globe' ),
		array( 'stream-icon-happy-smileystreamline' => 'happy-smiley' ),
		array( 'stream-icon-headset-soundstreamline' => 'headset-sound' ),
		array( 'stream-icon-home-housestreamline' => 'home-house' ),
		array( 'stream-icon-ibook-laptop' => 'ibook-laptop' ),
		array( 'stream-icon-ink-penstreamline' => 'ink-pen' ),
		array( 'stream-icon-ipadstreamline' => 'ipad' ),
		array( 'stream-icon-iphonestreamline' => 'iphone' ),
		array( 'stream-icon-ipod-mini-musicstreamline' => 'ipod-mini-music' ),
		array( 'stream-icon-ipod-musicstreamline' => 'ipod-music' ),
		array( 'stream-icon-ipodstreamline' => 'ipod' ),
		array( 'stream-icon-japanstreamline-tea' => 'japanstreamline-tea' ),
		array( 'stream-icon-laptop-macbookstreamline' => 'laptop-macbook' ),
		array( 'stream-icon-like-lovestreamline' => 'like-love' ),
		array( 'stream-icon-music-speakerstreamline' => 'music-speaker' ),
		array( 'stream-icon-remote-controlstreamline' => 'remote-control' ),
		array( 'stream-icon-receipt-shoppingstreamline' => 'receipt-shopping' ),
		array( 'stream-icon-music-notestreamline' => 'music-note' ),
		array( 'stream-icon-monocle-mustachestreamline' => 'monocle-mustache' ),
		array( 'stream-icon-picturestreamline-1' => 'picture-1' ),
		array( 'stream-icon-picturestreamline' => 'picture' ),
		array( 'stream-icon-micro-recordstreamline' => 'micro-record' ),
		array( 'stream-icon-mapstreamline-user' => 'maps' ),
		array( 'stream-icon-photo-picturesstreamline' => 'photo-pictures' ),
		array( 'stream-icon-penstreamline-3' => 'pens' ),
		array( 'stream-icon-map-pinstreamline' => 'map-pin' ),
		array( 'stream-icon-man-peoplestreamline-user' => 'man-people' ),
		array( 'stream-icon-penstreamline-2' => 'pen-2' ),
		array( 'stream-icon-penstreamline-1' => 'pen-1' ),
		array( 'stream-icon-magnetstreamline' => 'magnet' ),
		array( 'stream-icon-magic-magic-wandstreamline' => 'magic-wands' ),
		array( 'stream-icon-painting-rollstreamline' => 'painting-roll' ),
		array( 'stream-icon-macintosh' => 'macintosh' ),
		array( 'stream-icon-lockerstreamline-unlock' => 'locker' ),
		array( 'stream-icon-painting-palletstreamline' => 'painting-pallet' ),
		array( 'stream-icon-paint-bucketstreamline' => 'paint-bucket' ),
		array( 'stream-icon-lock-lockerstreamline' => 'lock-locker' ),
		array( 'stream-icon-linkstreamline' => 'link' ),
		array( 'stream-icon-notebookstreamline' => 'notebook' ),
		array( 'stream-icon-settingsstreamline' => 'setting' ),
		array( 'stream-icon-settingsstreamline-1' => 'setting-1' ),
		array( 'stream-icon-shoes-snickersstreamline' => 'shoes-snickers' ),
		array( 'stream-icon-speechstreamline-talk-user' => 'speechs' ),
		array( 'stream-icon-stampstreamline' => 'stamp' ),
		array( 'stream-iconstreamline-suitcase-travel' => 'suitcase-travel' ),
		array( 'stream-iconstreamline-sync' => 'sync' ),
		array( 'stream-iconstreamline-umbrella-weather' => 'umbrella-weather' ),
		array( 'stream-icon-settingsstreamline-2' => 'setting-2' ),
	);
