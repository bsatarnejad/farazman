 ...
 ?>		
    ...
    <div id="main" class="main">
        <div id="primary" class="content-area">
            <div class="sixteen columns jx-rebuild-padding">
       		   ...
       		   <div class="jx-rebuild-protfolio">       
                   <div class="jx-rebuild-portfolio-filter category-menu">
                        <ul>                                  
                            ...
                            <li><a class="filter active" data-filter="*" href="#">همه</a></li> 
                   ...
                   <div class="jx-rebuild-portfolio-grid-container">			
                       <?php
                       
                        $i=0;
                                        
                        $paged = (get_query_var('paged')) ? get_query_var('paged') : 1;          
                        $args = array('post_type' => 'portfolio','orderby' => 'date', 'order' => 'ASC','showposts' => 13,'paged'=>$paged );  
                        ...
                        while ( $loop->have_posts() ) : $loop->the_post();  
                            ...
                            ?>
                                ...
                                <div class="grid-item <?php echo esc_attr( $set_img_class ); ?> jx-rebuild-image-wrapper <?php echo esc_attr( $terms_string ); ?> all">
                                    <?php the_post_thumbnail(esc_attr( $imagesize )); ?>
                   ...
                   <div class="jx-rebuild-pagination">
                       <?php rebuild_pagination($loop->max_num_pages,esc_attr( $paged )); ?>
                   </div>
                   <!-- Pagination -->
               </div>      
