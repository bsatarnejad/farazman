...
if ( ! class_exists( 'RW_Meta_Box' ) )
{
	...
	class RW_Meta_Box
	{
					...
					<script type="text/javascript">
						if ( typeof rwmb == "undefined" )
						{
							var rwmb = {
								...
								summaryMessage : "' . esc_html__( 'Please correct the errors highlighted below and try again.', 'rebuild' ) . '"
							};
						}
						else
						{
		...
		static function end_html( $html, $meta, $field )
		{
			...
			$button = '';
			if ( $field['clone'] )
				$button = '<a href="#" class="rwmb-button button-primary add-clone">' . esc_html__( '+', 'rebuild' ) . '</a>';
		...
		{
			$button = '<a href="#" class="rwmb-button button remove-clone">' . esc_html__( '&#8211;', 'rebuild' ) . '</a>';
			return "{$html}{$button}";
		}
		/**
