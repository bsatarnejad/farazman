<?php
		...
		function rebuild_breadcrumbs() {
		  ...
		  //$before     = wp_kses( __( '<span class="current">', 'rebuild' ),array( 'span' => array( 'class' => array() ) )); 
		  //$after     = wp_kses( __( '</span>', 'rebuild' ),array( 'span')); // tag after the current crumb  
		  /* === END OF OPTIONS === */  
		  $parent_id='';
		  ...
		  if (is_home() || is_front_page()) {  
			...
			if ( get_query_var('paged') ) {  
			  ...
			  echo esc_html__('Page','rebuild') . ' ' . get_query_var('paged');  
			  if ( is_category() || is_day() || is_month() || is_year() || is_search() || is_tag() || is_author() ) echo ')';  
			}  
		...
		} // end dimox_rebuild_breadcrumbs()
		
		
		function rebuild_short_breadcrumbs() {
