        ...
        <div id="primary" class="content-area">
                <div class="container <?php echo esc_attr( $set_content_width ); ?>">
                    <div class="sixteen columns jx-rebuild-padding <?php echo esc_attr( $content_class ); ?>">
						<?php
                        $hide_breadcrumbs = '';
                        if ( isset( $rebuild_data['opt_hide_breadcrumbs_product'] ) && $rebuild_data['opt_hide_breadcrumbs_product'] != '0' ) {
                            $hide_breadcrumbs = $rebuild_data['opt_hide_breadcrumbs_product'];
                        }
